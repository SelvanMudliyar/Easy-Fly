          ...
          <div class="formgroup">
            <div class="inputBx">
              ...
              <div class="input-group flex-nowrap">
                <input type="text" class="form-control" aria-label="Name" aria-describedby="addon-wrapping" name="uname">
              </div><br>
              <p>Enter Your Email :</p>
              <div class="input-group flex-nowrap">
                <input type="email" class="form-control" aria-label="Email" aria-describedby="addon-wrapping" name="uemail">
              </div><br>
